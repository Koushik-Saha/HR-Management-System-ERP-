<section id="column-selectors">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <br>
                <h4 style="text-align: center;">All Staffs of <span
                            ...
                            <table class="table table-striped dataex-html5-selectors " id="allProjects">
                                ...
                                @foreach($staffs as $index => $labour)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" data-id="{{ $labour->id }}" name="status"
                                                   class="js-switch" {{ $labour->status == 1 ? 'checked' : '' }}>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a type="button" class="btn btn-outline-success" title="Edit Client"
                                               href="{{ route('manpower-edit', ['id' => $labour->id]) }}">
